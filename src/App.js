        ...
        <div>
            ...
            <form onSubmit={preventSubmit}>
                <div>
                    ...
                    <input id="search-text-1" tabIndex="1" type="text" placeholder="3 Letter Minimum" title="3 Letter Minimum" value={searchText1} onChange={handleText1}/>
