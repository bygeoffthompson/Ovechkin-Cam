...
function SearchForm({jsonData}) {
    ...
    useEffect(() => {
        ...
        if (queryInteger >= 1 && queryInteger <= 902) {
        ...
        <div>
            ...
            <form onSubmit={preventSubmit}>
                <div>
                    ...
                    <input id="search-goal" min="1" max="902" tabIndex="0" type="number" placeholder="#" value={searchGoal} onChange={handleGoalChange}/>
