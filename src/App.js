...
function SearchForm({jsonData}) {
    ...
    useEffect(() => {
        ...
        if (queryInteger >= 1 && queryInteger <= 901) {
        ...
        <div>
            ...
            <form onSubmit={preventSubmit}>
                <div>
                    ...
                    <input id="search-goal" min="1" max="901" tabIndex="0" type="number" placeholder="#" value={searchGoal} onChange={handleGoalChange}/>
